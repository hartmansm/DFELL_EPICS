...
/* Device Support routines for the CAMAC BiRa 2324 48-channel binary 
 * input module. This module has dual 24-bit input registers.
 *
...
/* Create the dset for devBiCamac2324 */
...
struct biRecord	*pbi;
{
	...
	unsigned short	reg = 0; /* input register, 0-23 -> 0, 24-47 -> 1 */
	...
	default :
		recGblRecordError(S_db_badField,(void *)pbi,
		    "devBiCamac2324 (init_record) Illegal INP field");
