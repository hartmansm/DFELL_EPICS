...
#ifndef drvWfVmi3122H
#define drvWfVmi3122H

int Vmi3122Config(int card,unsigned long baseoffset, unsigned int buffer,unsigned long rate, unsigned int irq_level, unsigned char ivec_base);
